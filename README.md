...
Add your MongoDB database's connection string like so:
MONGO_URI=YourConnectionStringHere
in the .env file
...
3 - 
cd into the api folder using the terminal and run `npm start`

4 - 
cd into the client folder using the terminal and run `npm start`
